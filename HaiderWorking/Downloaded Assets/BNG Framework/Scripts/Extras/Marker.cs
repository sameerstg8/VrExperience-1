        ...
        Vector3 DrawPoint(Vector3 lastDrawPoint, Vector3 endPosition, float lineWidth, Color lineColor, Quaternion rotation) {
            ...
            if (IsNewDraw || LineRenderer == null) {
                ...
                if (root == null) {
                    ...
                    if (Ahmad.TVFE.Managers.Experince1.Experince1Manager.experince1Manager)
                        Ahmad.TVFE.Managers.Experince1.Experince1Manager.experince1Manager.rootMarker = root;
