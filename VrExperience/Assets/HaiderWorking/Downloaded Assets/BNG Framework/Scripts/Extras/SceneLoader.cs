...
namespace BNG {
    public class SceneLoader : MonoBehaviour {
        ...
        #region Ahmad Custom Singleton Region
        private static SceneLoader _instance;
        public static SceneLoader sceneLoader { get { return _instance; } }
        #endregion
        private void Awake()
        {
            if (_instance)
        ...
        private void Start()
        {
            if(SceneManager.GetActiveScene().name == "OpeningScene1")
            {
                StartCoroutine(sceneLoaderFuntion());
        ...
        public IEnumerator sceneLoaderFuntion()
        {
