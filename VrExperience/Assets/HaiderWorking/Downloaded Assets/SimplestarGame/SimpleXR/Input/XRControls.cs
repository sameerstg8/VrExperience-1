...
public partial class @XRControls : IInputActionCollection2, IDisposable
{
    ...
    private IXRControlsActionsActions m_XRControlsActionsActionsCallbackInterface;
    ...
    public struct XRControlsActionsActions
    {
        ...
        {
            if (m_Wrapper.m_XRControlsActionsActionsCallbackInterface != null)
            {
                @LeftControllerPosition.started -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnLeftControllerPosition;
                @LeftControllerPosition.performed -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnLeftControllerPosition;
                @LeftControllerPosition.canceled -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnLeftControllerPosition;
                @RightControllerPosition.started -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnRightControllerPosition;
                @RightControllerPosition.performed -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnRightControllerPosition;
                @RightControllerPosition.canceled -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnRightControllerPosition;
                @LeftControllerTrigger.started -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnLeftControllerTrigger;
                @LeftControllerTrigger.performed -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnLeftControllerTrigger;
                @LeftControllerTrigger.canceled -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnLeftControllerTrigger;
                @RightControllerTrigger.started -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnRightControllerTrigger;
                @RightControllerTrigger.performed -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnRightControllerTrigger;
                @RightControllerTrigger.canceled -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnRightControllerTrigger;
                @LeftControllerRotation.started -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnLeftControllerRotation;
                @LeftControllerRotation.performed -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnLeftControllerRotation;
                @LeftControllerRotation.canceled -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnLeftControllerRotation;
                @RightControllerRotation.started -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnRightControllerRotation;
                @RightControllerRotation.performed -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnRightControllerRotation;
                @RightControllerRotation.canceled -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnRightControllerRotation;
                @LeftControllerGrip.started -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnLeftControllerGrip;
                @LeftControllerGrip.performed -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnLeftControllerGrip;
                @LeftControllerGrip.canceled -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnLeftControllerGrip;
                @RightControllerGrip.started -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnRightControllerGrip;
                @RightControllerGrip.performed -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnRightControllerGrip;
                @RightControllerGrip.canceled -= m_Wrapper.m_XRControlsActionsActionsCallbackInterface.OnRightControllerGrip;
            }
            m_Wrapper.m_XRControlsActionsActionsCallbackInterface = instance;
            if (instance != null)
            {
