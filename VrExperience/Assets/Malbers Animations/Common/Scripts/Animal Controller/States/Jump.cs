...
namespace MalbersAnimations.Controller
{
    public class Jump : State
    {
        ...
        public override void EnterTagAnimation()
        {
            ...
            else if (CurrentAnimTag == ExitTagHash && (animal.hash_StateOn == 0)) //Without State ON
            {
        ...
        public override void TryExitState(float DeltaTime)
        {
            ...
            {
                Debugging("[Allow Exit] Jump Profile Exit Time");
            ...
            internal void Reset()
        {
            ...
            { new JumpProfile()
            { name = "Jump",  fallingTime = 0.7f, /* fallRay = 2,*/ ForwardMultiplier = 1,  HeightMultiplier =  1, JumpLandDistance = 1.7f}
            };
        }
#endif
    }
